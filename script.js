const appState = {
    ...
    current_question: 0,
    current_quiz: "",
    current_quiz_repo: "Web-proj3",
    current_model: {}
};
//grants posative vibe messages if gotten right
const encouragingMessage = [
    `<div class="container"><img class="center" width="300px" height="300px" src="https://i.pinimg.com/736x/a1/59/43/a15943694af96cf11d3940dcc4bd09cd.jpg"></div>`,
    `<div class="container"><img class="center" width="300px" height="300px" src="https://static6.depositphotos.com/1005979/627/i/450/depositphotos_6270025-stock-photo-great-job-words-praising-a.jpg"></div>`,
    `<div class="container"><img class="center" width="300px" height="300px" src="https://t4.ftcdn.net/jpg/02/88/09/57/360_F_288095746_6s6fqCdkYCvXbC4ebCRYtU1F99Uv57S2.jpg"></div>`
];
    ...
    switch(e.target.id) {
        case "java_quiz": {
            if(document.querySelector("#user_name").value == "") {
                ...
                appState.current_quiz_repo = "Web-proj3";
                get_next_question();
            }
            break;
        }
...
async function get_next_question() {
    ...
    try{
        let question = await fetch(`https://my-json-server.typicode.com/AlexanderFox1/${appState.web-proj3}/${appState.web-proj3}?id=${appState.web-proj3}_question${appState.current_question}`);
...
function show_end_screen(passed) {
    var endMessage;
    if(passed) {
        endMessage = `Congrats, ${userName}! You passed the quiz, have a lolly pop(even though i cant give you one)!`
    }
    else {
        endMessage = `Sorry, ${userName}. You failed the quiz, feel free to try again.`
    }
